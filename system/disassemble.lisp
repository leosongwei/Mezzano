...
(defun slot-to-thread-slot-name (slot)
  (case slot
    (#.mezzano.supervisor::+thread-name+ "thread-name")
    (#.mezzano.supervisor::+thread-state+ "thread-state")
    (#.mezzano.supervisor::+thread-stack+ "thread-stack")
    (#.mezzano.supervisor::+thread-wait-item+ "thread-wait-item")
    (#.mezzano.supervisor::+thread-special-stack-pointer+ "thread-special-stack-pointer")
    (#.mezzano.supervisor::+thread-full-save-p+ "thread-full-save-p")
    (#.mezzano.supervisor::+thread-self+ "thread-self")
    (#.mezzano.supervisor::+thread-%next+ "thread-%next")
    (#.mezzano.supervisor::+thread-%prev+ "thread-%prev")
    (#.mezzano.supervisor::+thread-pending-footholds+ "thread-pending-footholds")
    (#.mezzano.supervisor::+thread-inhibit-footholds+ "thread-inhibit-footholds")
    (#.mezzano.supervisor::+thread-mutex-stack+ "thread-mutex-stack")
    ...
    (#.mezzano.supervisor::+thread-breakpoint-table+ "thread-breakpoint-table")
    (#.mezzano.supervisor::+thread-software-breakpoints+ "thread-software-breakpoints")
    (#.mezzano.supervisor::+thread-symbol-cache-hit-count+ "thread-symbol-cache-hit-count")
    (#.mezzano.supervisor::+thread-symbol-cache-miss-count+ "thread-symbol-cache-miss-count")
    (#.mezzano.supervisor::+thread-unsleep-helper+ "thread-unsleep-helper")
    (#.mezzano.supervisor::+thread-unsleep-helper-argument+ "thread-unsleep-helper-argument")
    (#.mezzano.supervisor::+thread-is-driver+ "thread-is-driver")
    (#.mezzano.supervisor::+thread-mv-slots-start+ "thread-mv-slots")
    (#.mezzano.supervisor::+thread-symbol-cache-start+ "thread-symbol-cache")
    (#.mezzano.supervisor::+thread-arm64-fpsr+ "thread-arm64-fpsr")
    (#.mezzano.supervisor::+thread-arm64-fpcr+ "thread-arm64-fpcr")
    (#.mezzano.supervisor::+thread-fx-save-area+ "thread-fx-save-area")
    (#.mezzano.supervisor::+thread-state-r15+ "thread-state-r15")
    (#.mezzano.supervisor::+thread-state-r14+ "thread-state-r14")
    (#.mezzano.supervisor::+thread-state-r13+ "thread-state-r13")
    (#.mezzano.supervisor::+thread-state-r12+ "thread-state-r12")
    (#.mezzano.supervisor::+thread-state-r11+ "thread-state-r11")
    (#.mezzano.supervisor::+thread-state-r10+ "thread-state-r10")
    (#.mezzano.supervisor::+thread-state-r9+ "thread-state-r9")
    (#.mezzano.supervisor::+thread-state-r8+ "thread-state-r8")
    (#.mezzano.supervisor::+thread-state-rdi+ "thread-state-rdi")
    (#.mezzano.supervisor::+thread-state-rsi+ "thread-state-rsi")
    (#.mezzano.supervisor::+thread-state-rbx+ "thread-state-rbx")
    (#.mezzano.supervisor::+thread-state-rdx+ "thread-state-rdx")
    (#.mezzano.supervisor::+thread-state-rcx+ "thread-state-rcx")
    (#.mezzano.supervisor::+thread-state-rax+ "thread-state-rax")
    (#.mezzano.supervisor::+thread-state-rbp+ "thread-state-rbp")
    (#.mezzano.supervisor::+thread-state-rip+ "thread-state-rip")
    (#.mezzano.supervisor::+thread-state-cs+ "thread-state-cs")
    (#.mezzano.supervisor::+thread-state-rflags+ "thread-state-rflags")
                           ...
                           (when (eql (logand (ea-disp operand) 7) 7)
                             (let ((slot (truncate (+ (ea-disp operand) 1) 8)))
                               ...
                               (when (eql (ea-segment operand) :gs)
                                 (let ((thread-slot (slot-to-thread-slot-name slot)))
                                   (when thread-slot
                   ...
                   ((integerp operand)
                    (cond ((eql operand (sys.int::lisp-object-address nil))
                          ...
                          ((and (eql (logand operand 15) sys.int::+tag-immediate+)
                                (or (eql (ldb sys.int::+immediate-tag+ operand) sys.int::+immediate-tag-byte-specifier+)
                                    (eql (ldb sys.int::+immediate-tag+ operand) sys.int::+immediate-tag-character+)
                                    (eql (ldb sys.int::+immediate-tag+ operand) sys.int::+immediate-tag-single-float+)))
